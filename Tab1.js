...
class Tab1 extends Component {
  ...
  SendCode = () => {
    const {phone, rand, id} = this.state;
  ...
  ConfirmCode = () => {
    ...
    if (rand !== numb) {
      ...
      fetch('https://jimbooexchange.com/php_api/update_user_isphoneok.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded', // <-- Specifying the Content-Type
        },
        body: `Id=${id}&Is_Phone_Ok=${'yes'}`, // <-- Post parameters
      });
    }
  };
  onSubmit = () => {
        ...
        <View style={{marginVertical: hp(2), marginHorizontal: wp(5)}}>
          ...
          <View>
            ...
            <View
              ...
              <AutoHeightWebView
                ...
                source={{
                  html: `
                  <p> دست نویسی با متن «اینجانب (نام و نام خانوادگی) به کد ملی (کد ملی) ضمن مطالعه و تایید قوانین استفاده از خدمات جیمبو متعهد میگردم حساب کاربری و مدارک خود را در اختیار اشخاص غیر قرار ندهم و در صورت تخلف، مسئولیت آن را بر عهده بگیرم.جهت احراز هویت در سایت جیمبو - تاریخ - امضاء» تهیه کرده و به همراه کارت ملی ، کارت بانکی همنام ( ترجیحاً روی تاریخ و CVV2 پوشانده شود) ، تصویر و دستنویس خود عکسی سلفی بگیرید. توجه داشته باشید که تصویر شما، کارت ملی و دست نویس همگی واضح باشند و در سایت بارگزاری نمایید.</P>
                `,
                }}
          ...
          <View style={{marginTop: hp(3)}}>
            ...
            {sms === 'no' ? (
              ...
              <View>
                <Text size="sm" style={{color: 'green', marginTop: '2%'}}>
                  احراز هویت شماره تماس شما به درستی انجام شده است
                </Text>
              </View>
            )}
          </View>

                        ...
                        !this.state.clearInput2
                          ? this.renderTitle2() === 'تومان'
                            ? ` ${persianNumber(
                                ...
                                ? +Math.abs( this.state.arz * this.renderRial(),).toPrecision(
                                    String(Math.abs( this.state.arz * this.renderRial(),)).indexOf('.') + 5,
                                  )
                                : +Math.abs( this.state.arz * this.renderRial(),).toFixed(5), 
                                ),
                              )} `
                            : ` ${persianNumber(
                                numberWithCommas(
                                  ...
                                  ? +Math.abs(this.state.arz / this.renderRial2()).toPrecision(
                                      String(Math.abs(this.state.arz / this.renderRial2())).indexOf('.') + 5,
                                    )
                                  : +Math.abs(this.state.arz / this.renderRial2()).toFixed(5), 
                                ),
                              )} `
                          : null
                      }
                          ...
                          ? this.renderTitle2() === 'تومان'
                            ? ` ${persianNumber(
                                numberWithCommas(
                                  ...
                                  ? +Math.abs(this.state.rial / this.renderRial()).toPrecision(
                                      String(Math.abs(this.state.rial / this.renderRial())).indexOf('.') + 5,
                                    )
                                  : +Math.abs(this.state.rial / this.renderRial()).toFixed(5), 
                                ),
                              )} `
                            : ` ${persianNumber(
                                numberWithCommas(
                                  ...
                                  ? +Math.abs(this.state.rial * this.renderRial2()).toPrecision(
                                      String(Math.abs(this.state.rial * this.renderRial2())).indexOf('.') + 5,
                                    )
                                  : +Math.abs(this.state.rial * this.renderRial2()).toFixed(5),
                                ),
                              )} `
                          : null;
                      }}
